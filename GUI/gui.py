...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.ac_predict_button = customtkinter.CTkButton(master=self.tabview.tab("Audio classification"),
                                                         text="Create genre predictions", command=self.ac_predict_genre,
                                                         font=("Helvetica", 16))
    ...
    def ac_predict_genre(self):
        ...
        match model:
            case "EfficientNet":
                ...
                genres, percentages = efficientnet_model.testefficientnetmodel(join(self.audios_dir, "effnet_spec"),
            ...
            case "CNN (Spectrogram)":
                ...
                spectrogram_models.testimagemodel(join(self.audios_dir, "cnn_spec"),
            ...
            case "CNN" | "LSTM":
                ...
                if model == "CNN":
                    genres, percentages = mfcc_models.testaudiomodel(data,
                                                                     os.path.abspath(
    ...
    def ac_create_predictions_plot(self, model, genres, percentages):
        ...
        for i in range(len(genres)):
            ...
            if len(genres[i]) == 1:
                plt.xlim(-1, 1)
            plt.savefig(fname=os.path.join(self.audios_dir, "genre_predictions", filename) + ".png", format='png', bbox_inches="tight", transparent=True)
        plt.clf()
