...
if __name__ == '__main__':
    ...
    scratch_lda_model.create_wordcloud()
    # lda_model.predict_text()
    ...
    # mfcc_models.createLSTMmodel(data)
    # general.plot_logger("C:/Users/Utente/UNI/tesina_LAUREA/audio_classification/GTZAN_DB/loggers/EFFNET.log")
